...
import { float, vec2, vec3, vec4, int, add, sub, mul, div, mod, atan, mix, pow, smoothstep } from 'three/src/nodes/tsl/TSLBase.js';
...
import { frameId, time } from 'three/src/nodes/utils/Timer.js';
